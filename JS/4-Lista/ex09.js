...
Por exemplo, a nota 84 será arredondada para 85, mas a nota 29 não será arredondada por ser abaixo de 40 e não
ser possível arredondamento eficiente, ou seja, que evite a reprovação do aluno.
No caso de a nota ser 38, o arredondamento é possível pois atingirá 40 e o aluno será aprovado.
*/

function statusAluno (notaStatus)
{
    let notaArred = arredondar(notaStatus)
    ...
    {
        console.log(`Reprovado com nota ${notaStatus}!`)
    }
}

//lembrando que ele compila as funcoes primeiro...
